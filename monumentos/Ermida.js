...
import catedral from '../images/monumentos/ERMIDA.png';
...
export default class Apresentacao extends Component {
    ...
    constructor(props) {
        super(props);
        falas = [
            'A capela Ermida Dom Bosco foi inaugurada em 1957 e projetada pelo arquiteto Oscar Niemeyer em homenagem ao Padre Dom Bosco, copadroeiro de Brasília.',
            'Está localizada no Parque Ecológico Ermida Dom Bosco, próximo ao Palácio da Alvorada, residência oficial do Presidente da República.',
