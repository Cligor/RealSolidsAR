...
export default class Apresentacao extends Component {
    ...
    constructor(props) {
        super(props);
        falas = [
            'A pirâmide do Louvre é um projeto do arquiteto sino-americano I. M. Pei. Inaugurada em 1988, está situada na praça central do museu, a Cour Napoléon.',
            'A construção deste edifício provocou um grande debate. O argumento da turma do contra era que esta forma futurista, com um estilo internacional, estava fora do contexto clássico do museu.',
